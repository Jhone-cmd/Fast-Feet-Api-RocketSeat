...
type EditRecipientUseCaseResponse = Either<ResourceNotFound, { recipient: Recipient }>

export class EditRecipientUseCase {
    
    constructor (private recipientRepository: RecipientRepository) {}
    
    async execute({ recipientId, name, address, phone }: EditRecipientUseCaseRequest): Promise<EditRecipientUseCaseResponse> {
